package com.example.SpringSecurityRegDemo.security;
...
public class UserDTO {
	...
	public UserDTO(@NotEmpty String userName,
			...
			@Pattern(regexp = "[A-Za-z]+$", message = "Only alphabetic allowed") String lastName, @Email String email,
			String phone, @Pattern(regexp = "[0-9]{5}$", message = "Zip code wrong format") String zip,
